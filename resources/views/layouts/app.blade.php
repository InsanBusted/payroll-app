    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-slate-900 flex flex-col z-50 overflow-y-auto transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
            ...
            <div class="flex items-center gap-3 px-5 py-5 border-b border-white/10">
                ...
                <div>
                    ...
                    <div class="text-slate-400 text-xs">Payroll MMT</div>
                </div>
            </div>
            ...
            <div class="px-3 py-4 border-t border-white/10">
                <a href="{{ route('profile.edit') }}"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 transition-colors group">
                    <div
                        class="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-300 flex items-center justify-center text-xs font-bold text-white flex-shrink-0">
        ...
        <div class="lg:ml-64 flex-1 flex flex-col min-w-0">
            ...
            <main class="flex-1 p-4 lg:p-8 overflow-x-hidden">
                ...
                @if (session('error'))
                    <div
                        class="flex items-center gap-3 bg-red-50 border border-red-200 text-red-800 text-sm font-medium px-5 py-3.5 rounded-xl mb-6">
                        <svg class="w-5 h-5 flex-shrink-0 text-red-400" fill="none" stroke="currentColor"
                            stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
