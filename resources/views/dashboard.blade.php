<x-app-layout>
    <x-slot name="title">Dashboard cholis gaji</x-slot>
    ...
    @else
        ...
        <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
                @foreach ([
                    ['Tambah Karyawan', 'M12 4v16m8-8H4', route('employees.index')],
                    ['Import Kinerja',  'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12', route('kinerjas.index')],
                    ['Kinerja Bulanan', 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', route('kinerjas.index')],
