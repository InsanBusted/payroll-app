...
class Pph21Seeder extends Seeder
{
    public function run(): void
    {
        ...
        */
        ...
        DB::table('ptkp_categories')->insert([
            [
                'id' => 1,
                'code' => 'A',
                'description' => 'TK/0, TK/1, K/0',
            ],
            [
                'id' => 2,
                'code' => 'B',
                'description' => 'TK/2, TK/3, K/1, K/2',
            ],
            [
                'id' => 3,
                'code' => 'C',
        ...
        */
        ...
        DB::table('ptkp_statuses')->insert([
            ['status' => 'TK/0', 'category_id' => 1],
            ['status' => 'TK/1', 'category_id' => 1],
            ['status' => 'K/0',  'category_id' => 1],

            ['status' => 'TK/2', 'category_id' => 2],
            ['status' => 'TK/3', 'category_id' => 2],
            ['status' => 'K/1',  'category_id' => 2],
            ['status' => 'K/2',  'category_id' => 2],

            ['status' => 'K/3',  'category_id' => 3],
        ]);
        ...
        */
        ...
        $this->insertRates(1, $terA);
        $this->insertRates(2, $terB);
        $this->insertRates(3, $terC);
    }

    private function insertRates($categoryId, $rows): void
    {
        foreach ($rows as $row) {
            DB::table('ter_rates')->insert([
